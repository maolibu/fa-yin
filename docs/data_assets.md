...
| 法脉库 | `data/db/lineage.db`，来源为 DILA 佛学规范资料库（CC BY-SA 3.0） | 44,654,592 bytes；SHA-256 `2cdc429c4cfb2841e1ee0eb2b73bb91506293d3e122716a7405deffd46be026f`；6 个业务表 | 旧工作区没有 DILA→SQLite builder。当前库有 Git bundle、SQLite 冻结快照和表级摘要可恢复；现用 2026-02 人物/地名与 2012-02 时间原料已从旧路径迁入主项目归档，2026-08 候选源保存于 `下载/2026-08_dila_authority/`。在单独完成 builder 和升级对照前不覆盖正式库。 |
