...
汉传佛典汗牛充栋，即便有了 CBETA 数字化成果，阅藏时仍然面临工具割裂的困境：经卷在此，注疏在彼，词典又散见他处，多窗口频繁切换极易打断思绪。若有一方工具，能将散落卷帙收摄于同一案头，该多好。这个想法搁置了多年，直到近年来 AI 辅助编程突飞猛进，才终于有了动手的勇气。
...
> **提示**：如果你想在绿联 NAS (如 DX4600) 或装有 1Panel 面板的云服务器 (VPS) 上通过 Docker Compose 部署，请参考详细教程：[NAS 与 1Panel 部署指南](docs/deploy_nas_1panel.md)。
